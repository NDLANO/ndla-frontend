...
import { convertResult, resultsWithContentTypeBadgeAndImage } from '../SearchPage/searchHelpers';
...
const MovedResourcePage = ({ resource, locale, t }) => {
  ...
  const convertedResults = convertResult(data.search.results, [], 'all', locale);

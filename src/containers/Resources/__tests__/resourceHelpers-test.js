...
test('resourceHelpers/getArticleIdFromResource ', () => {
  ...
  testHelper(helper.getArticleIdFromResource, { contentUri: 'urn:article:123s0-dfnsdf-jkhs-dhfkj1l237' }, '123s0-dfnsdf-jkhs-dhfkj1l237');
...
test('resourceHelpers/getLearningPathIdFromResource ', () => {
  ...
  testHelper(helper.getLearningPathIdFromResource, { contentUri: 'urn:learningpath:123s0-dfnsdf-jkhs-dhfkj1l237' }, '123s0-dfnsdf-jkhs-dhfkj1l237');

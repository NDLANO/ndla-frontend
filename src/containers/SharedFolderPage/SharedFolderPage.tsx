...
import { useGetSharedFolder, useFolderResourceMetaSearch } from "../../mutations/folder/folderQueries";
                ...
                return resourceMeta ? (
                  <li key={resource.id}>
                    <ListResource
                      ...
                      traits={
                        resourceMeta?.__typename === "ArticleFolderResourceMeta" ? resourceMeta.traits : undefined
                      }

...
import { GQLArticle, GQLSubject, GQLTopic, GQLLearningpath,GQLLearningpathStep } from "../graphqlTypes";

type DimensionKeys = "3" | "4" | "5" | "6" | "7" | "8" | "9" | "10" | "13" | "14" | "19" | "20" ;
...
export const convertToGaOrGtmDimension = (dimensions:DimensionType, type: 'ga' | 'gtm') => {
  const newDimensions = {};
  Object.keys(dimensions).forEach(key => {
    Object.assign(newDimensions, {
      [getDimensionsCodes[key as DimensionKeys][type]]: dimensions[key as DimensionKeys],
    });
  });

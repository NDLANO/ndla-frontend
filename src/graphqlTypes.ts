...
export type GQLMultidisciplinaryTopic_TopicFragment = {
  __typename?: "Node";
  path: string;
  subtopics?: Array<{ __typename?: "Node"; id: string; name: string }>;
  meta?: {
    __typename?: "Meta";
    title: string;
    metaDescription?: string;
...
export type GQLResourceContextPageQuery = {
  ...
  node?: {
    ...
    contexts: Array<{ __typename?: "TaxonomyContext" } & GQLContextPage_ContextFragment>;
    article?: {
      __typename?: "Article";
      created: string;
      updated: string;
...
export type GQLToolboxSubjectContainer_SubjectFragment = {
  ...
  path: string;
  url: string;
  topics?: Array<{ __typename?: "Node"; name: string; id: string }>;
  subjectpage?: {
    __typename?: "SubjectPage";
    id: number;
    metaDescription?: string;
...
export type GQLToolboxTopicWrapper_TopicFragment = {
  ...
  subtopics?: Array<{ __typename?: "Node"; id: string; name: string; path: string }>;
} & GQLResources_TopicFragment;

...
export type GQLPodcastSeriesSearch = {
  ...
  results?: Maybe<Array<GQLPodcastSeriesSummary>>;
  totalCount: Scalars['Int'];
};
...
export type GQLAudioFragment = { __typename?: 'Audio', id: number, revision: number, supportedLanguages?: Maybe<Array<string>>, audioType: string, created: string, updated: string, title: { __typename?: 'Title', title: string, language: string }, audioFile: { __typename?: 'AudioFile', url: string, mimeType: string, fileSize: number, language: string }, copyright: (
    { __typename?: 'Copyright' }
    & GQLCopyrightInfoFragment
  ), tags?: Maybe<{ __typename?: 'Tags', tags?: Maybe<Array<string>>, language: string }>, manuscript?: Maybe<{ __typename?: 'Manuscript', manuscript: string, language: string }>, podcastMeta?: Maybe<{ __typename?: 'PodcastMeta', introduction: string, language: string, coverPhoto: { __typename?: 'CoverPhoto', id: string, url: string, altText: string } }> };

export type GQLAudioSummaryFragment = { __typename?: 'AudioSummary', id: number, url: string, license: string, supportedLanguages?: Maybe<Array<string>>, audioType: string, lastUpdated: string, title: { __typename?: 'Title', title: string, language: string }, tags?: Maybe<{ __typename?: 'Tags', tags?: Maybe<Array<string>>, language: string }>, manuscript?: Maybe<{ __typename?: 'Manuscript', manuscript: string, language: string }>, podcastMeta?: Maybe<{ __typename?: 'PodcastMeta', introduction: string, language: string, coverPhoto: { __typename?: 'CoverPhoto', id: string, url: string, altText: string } }> };

export type GQLPodcastSeriesFragment = { __typename?: 'PodcastSeries', id: number, supportedLanguages?: Maybe<Array<string>>, title: { __typename?: 'Title', title: string, language: string }, description: { __typename?: 'Description', description: string, language: string }, coverPhoto: { __typename?: 'CoverPhoto', id: string, url: string, altText: string } };

export type GQLPodcastSeriesSummaryFragment = { __typename?: 'PodcastSeriesSummary', id: number, supportedLanguages?: Maybe<Array<string>>, title: { __typename?: 'Title', title: string, language: string }, description: { __typename?: 'Description', description: string, language: string }, coverPhoto: { __typename?: 'CoverPhoto', id: string, url: string, altText: string } };

export type GQLAudioWithSeriesFragment = (
  { __typename?: 'Audio', series?: Maybe<(
    { __typename?: 'PodcastSeries' }
...
export type GQLPodcastSeriesWithEpisodesFragment = (
  { __typename?: 'PodcastSeries', episodes?: Maybe<Array<(
    { __typename?: 'Audio' }
    & GQLAudioFragment
  )>> }
  & GQLPodcastSeriesFragment
...
export type GQLPodcastSeriesWithEpisodesSummaryFragment = (
  { __typename?: 'PodcastSeriesSummary', episodes?: Maybe<Array<(
    { __typename?: 'AudioSummary' }
    & GQLAudioSummaryFragment
  )>> }
...
export type GQLPodcastQueryQuery = { __typename?: 'Query', podcast?: Maybe<(
    { __typename?: 'Audio' }
    & GQLAudioWithSeriesFragment
  )> };
...
export type GQLPodcastSearchQueryQuery = { __typename?: 'Query', podcastSearch?: Maybe<{ __typename?: 'AudioSearch', totalCount?: Maybe<number>, page?: Maybe<number>, pageSize?: Maybe<number>, results?: Maybe<Array<(
      { __typename?: 'Audio' }
      & GQLAudioWithSeriesFragment
    )>> }> };
...
export type GQLPodcastSeriesQueryQuery = { __typename?: 'Query', podcastSeries?: Maybe<(
    { __typename?: 'PodcastSeries' }
    & GQLPodcastSeriesWithEpisodesFragment
  )> };
...
export type GQLPodcastSeriesSearchQueryQuery = { __typename?: 'Query', podcastSeriesSearch?: Maybe<{ __typename?: 'PodcastSeriesSearch', totalCount: number, page?: Maybe<number>, pageSize: number, language: string, results?: Maybe<Array<(
      { __typename?: 'PodcastSeriesSummary' }

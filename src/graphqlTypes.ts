...
export type GQLSearchQuery = { __typename?: 'Query', search?: Maybe<{ __typename?: 'Search', language: string, page?: Maybe<number>, pageSize: number, totalCount: number, results: Array<{ __typename?: 'ArticleSearchResult', id: number, url: string, metaDescription: string, title: string, supportedLanguages: Array<string>, traits: Array<string>, metaImage?: Maybe<{ __typename?: 'MetaImage', url: string, alt: string }>, contexts: Array<{ __typename?: 'SearchContext', id: string, breadcrumbs: Array<string>, relevance: string, language: string, learningResourceType: string, path: string, subject: string, subjectId: string, resourceTypes: Array<{ __typename?: 'SearchContextResourceTypes', id: string, name: string, language: string }> }> } | { __typename?: 'LearningpathSearchResult', id: number, url: string, metaDescription: string, title: string, supportedLanguages: Array<string>, traits: Array<string>, metaImage?: Maybe<{ __typename?: 'MetaImage', url: string, alt: string }>, contexts: Array<{ __typename?: 'SearchContext', id: string, breadcrumbs: Array<string>, relevance: string, language: string, learningResourceType: string, path: string, subject: string, subjectId: string, resourceTypes: Array<{ __typename?: 'SearchContextResourceTypes', id: string, name: string, language: string }> }> }>, suggestions: Array<{ __typename?: 'SuggestionResult', name: string, suggestions: Array<{ __typename?: 'SearchSuggestion', text: string, offset: number, length: number, options: Array<{ __typename?: 'SuggestOption', text: string, score: number }> }> }> }> };

export type GQLSearchFilmArticleSearchResultFragment = { __typename?: 'ArticleSearchResult', id: number, url: string, metaDescription: string, title: string, supportedLanguages: Array<string>, traits: Array<string>, metaImage?: Maybe<{ __typename?: 'MetaImage', url: string, alt: string }>, contexts: Array<{ __typename?: 'SearchContext', breadcrumbs: Array<string>, relevance: string, language: string, learningResourceType: string, path: string, subject: string, resourceTypes: Array<{ __typename?: 'SearchContextResourceTypes', id: string, name: string, language: string }> }> };

export type GQLSearchFilmLearningpathSearchResultFragment = { __typename?: 'LearningpathSearchResult', id: number, url: string, metaDescription: string, title: string, supportedLanguages: Array<string>, traits: Array<string>, metaImage?: Maybe<{ __typename?: 'MetaImage', url: string, alt: string }>, contexts: Array<{ __typename?: 'SearchContext', breadcrumbs: Array<string>, relevance: string, language: string, learningResourceType: string, path: string, subject: string, resourceTypes: Array<{ __typename?: 'SearchContextResourceTypes', id: string, name: string, language: string }> }> };
...
export type GQLGroupSearchQuery = { __typename?: 'Query', groupSearch?: Maybe<Array<{ __typename?: 'GroupSearch', resourceType: string, totalCount: number, language: string, resources: Array<(
      { __typename?: 'GroupSearchResult' }
      & GQLGroupSearchResourceFragment
    )>, aggregations: Array<{ __typename?: 'AggregationResult', values: Array<{ __typename?: 'BucketResult', value: string }> }>, suggestions: Array<{ __typename?: 'SuggestionResult', suggestions: Array<{ __typename?: 'SearchSuggestion', options: Array<{ __typename?: 'SuggestOption', text: string }> }> }> }>>, competenceGoals?: Maybe<Array<{ __typename?: 'CompetenceGoal', id: string, type: string, name: string, curriculum?: Maybe<{ __typename?: 'Reference', id: string, title: string }>, competenceGoalSet?: Maybe<{ __typename?: 'Reference', id: string, title: string }> }>> };

export type GQLConceptSearchConceptFragment = { __typename?: 'Concept', id: number, title: string, text: string, image: { __typename?: 'MetaImage', url: string, alt: string } };
...
export type GQLConceptSearchQuery = { __typename?: 'Query', conceptSearch?: Maybe<{ __typename?: 'ConceptResult', concepts: Array<(
      { __typename?: 'Concept' }
...
export type GQLConceptCopyrightInfoFragment = { __typename?: 'ConceptCopyright', origin?: Maybe<string>, license?: Maybe<{ __typename?: 'License', license: string, url?: Maybe<string> }>, creators: Array<(
    { __typename?: 'Contributor' }
...
export type GQLMetaInfoFragment = { __typename?: 'Meta', id: number, title: string, introduction?: Maybe<string>, metaDescription?: Maybe<string>, lastUpdated?: Maybe<string>, metaImage?: Maybe<{ __typename?: 'MetaImage', url: string, alt: string }> };
...
export type GQLArticleInfoFragment = { __typename?: 'Article', id: number, title: string, introduction?: Maybe<string>, content: string, articleType: string, revision: number, metaDescription: string, supportedLanguages?: Maybe<Array<string>>, tags?: Maybe<Array<string>>, created: string, updated: string, published: string, oldNdlaUrl?: Maybe<string>, grepCodes?: Maybe<Array<string>>, oembed?: Maybe<string>, conceptIds?: Maybe<Array<string>>, metaImage?: Maybe<{ __typename?: 'MetaImage', url: string, alt: string }>, requiredLibraries?: Maybe<Array<{ __typename?: 'ArticleRequiredLibrary', name: string, url: string, mediaType: string }>>, metaData?: Maybe<{ __typename?: 'ArticleMetaData', copyText?: Maybe<string>, footnotes?: Maybe<Array<{ __typename?: 'FootNote', ref: number, title: string, year: string, authors: Array<string>, edition?: Maybe<string>, publisher?: Maybe<string>, url?: Maybe<string> }>>, images?: Maybe<Array<{ __typename?: 'ImageLicense', title: string, altText: string, src: string, copyText?: Maybe<string>, copyright: (
        { __typename?: 'Copyright' }
        & GQLCopyrightInfoFragment
        ...
        { __typename?: 'ConceptCopyright' }
        & GQLConceptCopyrightInfoFragment
...
type GQLTaxonomyEntityInfo_Resource_Fragment = { __typename?: 'Resource', id: string, name: string, contentUri?: Maybe<string>, path: string, resourceTypes?: Maybe<Array<{ __typename?: 'ResourceType', id: string, name: string }>> };

type GQLTaxonomyEntityInfo_Subject_Fragment = { __typename?: 'Subject', id: string, name: string, contentUri?: Maybe<string>, path: string };

type GQLTaxonomyEntityInfo_Topic_Fragment = { __typename?: 'Topic', id: string, name: string, contentUri?: Maybe<string>, path: string };
...
export type GQLSubjectPageInfoFragment = { __typename?: 'SubjectPage', id: number, metaDescription?: Maybe<string>, topical?: Maybe<(
  ...
  )>, banner: { __typename?: 'SubjectPageBanner', desktopUrl: string }, about?: Maybe<{ __typename?: 'SubjectPageAbout', title: string, description: string, visualElement: { __typename?: 'SubjectPageVisualElement', type: string, url: string, alt?: Maybe<string> } }>, editorsChoices: Array<(
    { __typename?: 'Resource' }
    & GQLTaxonomyEntityInfo_Resource_Fragment
  ) | (
    { __typename?: 'Subject' }
...
export type GQLSubjectPageWithTopicsQuery = { __typename?: 'Query', subject?: Maybe<(
    ...
    { __typename?: 'Topic', alternateTopics?: Maybe<Array<{ __typename?: 'Topic', id: string, name: string, path: string, breadcrumbs?: Maybe<Array<Array<string>>>, meta?: Maybe<(
        { __typename?: 'Meta' }
        & GQLMetaInfoFragment
      )> }>> }
    & GQLTopicInfoFragment
...
export type GQLLearningpathInfoFragment = { __typename?: 'Learningpath', id: number, title: string, description: string, duration?: Maybe<number>, lastUpdated: string, supportedLanguages: Array<string>, tags: Array<string>, copyright: { __typename?: 'LearningpathCopyright', license: { __typename?: 'License', license: string, url?: Maybe<string>, description?: Maybe<string> }, contributors: Array<(
      { __typename?: 'Contributor' }
      & GQLContributorInfoFragment
    )> }, coverphoto?: Maybe<{ __typename?: 'LearningpathCoverphoto', url?: Maybe<string>, metaUrl: string }>, learningsteps: Array<{ __typename?: 'LearningpathStep', id: number, title: string, description?: Maybe<string>, seqNo: number, type: string, showTitle: boolean, oembed?: Maybe<{ __typename?: 'LearningpathStepOembed', type: string, version: string, height: number, html: string, width: number }>, embedUrl?: Maybe<{ __typename?: 'LearningpathStepEmbedUrl', url: string, embedType: string }>, resource?: Maybe<(
...
export type GQLIframeResourceFragment = { __typename?: 'Resource', id: string, name: string, path: string, resourceTypes?: Maybe<Array<{ __typename?: 'ResourceType', id: string, name: string }>> };
...
export type GQLIframeArticleQuery = { __typename?: 'Query', article?: Maybe<(
  ...
  )>, topic?: Maybe<{ __typename?: 'Topic', id: string, name: string, path: string }> };
...
export type GQLTopicWithPathTopicsQuery = { __typename?: 'Query', subject?: Maybe<{ __typename?: 'Subject', id: string, name: string, path: string, topics?: Maybe<Array<(
      ...
      { __typename?: 'Topic' }
      & GQLTopicInfoFragment
    )>> }>, topic?: Maybe<{ __typename?: 'Topic', id: string, name: string, path: string, relevanceId?: Maybe<string>, pathTopics?: Maybe<Array<Array<{ __typename?: 'Topic', id: string, name: string, path: string }>>>, meta?: Maybe<(
      { __typename?: 'Meta' }
      & GQLMetaInfoFragment
...
export type GQLTopicQueryTopicFragment = { __typename?: 'Topic', id: string, name: string, path: string, parent?: Maybe<string>, relevanceId?: Maybe<string>, meta?: Maybe<(
    { __typename?: 'Meta' }
    & GQLMetaInfoFragment
  )>, subtopics?: Maybe<Array<{ __typename?: 'Topic', id: string, name: string, relevanceId?: Maybe<string> }>>, article?: Maybe<(
    { __typename?: 'Article' }
...
export type GQLMovieInfoFragment = { __typename?: 'Movie', id: string, title: string, metaDescription: string, path: string, metaImage?: Maybe<{ __typename?: 'MetaImage', alt: string, url: string }>, resourceTypes: Array<{ __typename?: 'ResourceType', id: string, name: string }> };

export type GQLFilmFrontPageQueryVariables = Exact<{ [key: string]: never; }>;


export type GQLFilmFrontPageQuery = { __typename?: 'Query', filmfrontpage?: Maybe<{ __typename?: 'FilmFrontpage', name: string, about: Array<{ __typename?: 'FilmPageAbout', title: string, description: string, language: string, visualElement: { __typename?: 'SubjectPageVisualElement', type: string, alt?: Maybe<string>, url: string } }>, movieThemes: Array<{ __typename?: 'MovieTheme', name: Array<{ __typename?: 'Name', name: string, language: string }>, movies: Array<(
        { __typename?: 'Movie' }
...
export type GQLMastHeadQuery = { __typename?: 'Query', subject?: Maybe<{ __typename?: 'Subject', id: string, name: string, path: string, paths: Array<string>, relevanceId: string, grepCodes: Array<string>, metadata: { __typename?: 'TaxonomyMetadata', visible?: Maybe<boolean> }, topics?: Maybe<Array<(
      { __typename?: 'Topic' }
      & GQLTopicInfoFragment
...
export type GQLResourcePageQuery = { __typename?: 'Query', subject?: Maybe<{ __typename?: 'Subject', id: string, name: string, path: string, topics?: Maybe<Array<{ __typename?: 'Topic', id: string, name: string, parent?: Maybe<string>, path: string, relevanceId?: Maybe<string>, meta?: Maybe<(
        { __typename?: 'Meta' }
        & GQLMetaInfoFragment
      )> }>> }>, resourceTypes?: Maybe<Array<{ __typename?: 'ResourceTypeDefinition', id: string, name: string, subtypes?: Maybe<Array<{ __typename?: 'ResourceTypeDefinition', id: string, name: string }>> }>>, topic?: Maybe<{ __typename?: 'Topic', id: string, name: string, path: string, relevanceId?: Maybe<string>, coreResources?: Maybe<Array<(
      { __typename?: 'Resource' }
      & GQLResourceInfoFragment
    )>>, supplementaryResources?: Maybe<Array<(
      { __typename?: 'Resource' }

...
export type GQLSubjectPageQueryInfoFragment = { __typename?: 'Subject', id: string, name: string, path: string, topics?: Maybe<Array<(
    { __typename?: 'Topic' }
    & GQLTopicInfoFragment
  )>> };
...
export type GQLSubjectPageQuery = { __typename?: 'Query', subject?: Maybe<(
    { __typename?: 'Subject', allTopics?: Maybe<Array<(
      { __typename?: 'Topic' }
      & GQLTopicInfoFragment
    )>>, subjectpage?: Maybe<(
      { __typename?: 'SubjectPage' }
...
export type GQLMultiDisciplinarySubjectPageQuery = { __typename?: 'Query', subject?: Maybe<(
    { __typename?: 'Subject', allTopics?: Maybe<Array<(
      { __typename?: 'Topic' }
      & GQLTopicInfoFragment
    )>> }
...
export type GQLFilmSubjectPageQuery = { __typename?: 'Query', subject?: Maybe<(
    { __typename?: 'Subject' }
    & GQLSubjectPageQueryInfoFragment
  )> };
...
export type GQLLearningpathInfoFragment = { __typename?: 'Learningpath', id: number, title: string, description: string, duration?: Maybe<number>, lastUpdated: string, supportedLanguages: Array<string>, tags: Array<string>, copyright: { __typename?: 'LearningpathCopyright', license: { __typename?: 'License', license: string, url?: Maybe<string>, description?: Maybe<string> }, contributors: Array<(
      { __typename?: 'Contributor' }
      & GQLContributorInfoFragment
    )> }, coverphoto?: Maybe<{ __typename?: 'LearningpathCoverphoto', url: string, metaUrl: string }>, learningsteps: Array<{ __typename?: 'LearningpathStep', id: number, title: string, description?: Maybe<string>, seqNo: number, type: string, showTitle: boolean, oembed?: Maybe<{ __typename?: 'LearningpathStepOembed', type: string, version: string, height: number, html: string, width: number }>, embedUrl?: Maybe<{ __typename?: 'LearningpathStepEmbedUrl', url: string, embedType: string }>, resource?: Maybe<(

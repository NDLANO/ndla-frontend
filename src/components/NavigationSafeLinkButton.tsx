...
type Props = SafeLinkButtonProps & NavigationSafeLinkButtonVariantProps & { ref?: RefObject<HTMLAnchorElement> };

export const NavigationSafeLinkButton = ({ css: cssProp, ref, ...props }: Props) => (
  <SafeLinkButton

        ...
        <MediaListContent>
          ...
          {!isCopyrighted(video.copyright?.license.license) && (
            <MediaListItemActions>
              ...
              <CopyTextButton
                stringToCopy={`<iframe title="${video.title}" height="${video.iframe?.height}" aria-label="${video.title}" width="${video.iframe?.width}" style="border: none;" allow="fullscreen" src="${video.iframe?.src}"></iframe>`}

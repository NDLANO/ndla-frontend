import ListItem from "@ndla/ui/lib/MultidisciplinarySubject/ListItem";
...
let subjectsIdx: SubjectIdType = {} as SubjectIdType;
...
export const getSubjectBySubjectIdFilters = (subjectId: string, filters: string ) => {
  const subjects = [
    ...commonSubjects,
    ...programmeSubjects,
    ...studySpecializationSubjects,
  ...
  return subjects.find((subject) => {
    if (subject.subjectId === subjectId) {
      ...
      if (subject.filters?.length === filters.length) {
        return subject.filters.every((filter: string) => {

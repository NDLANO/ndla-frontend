export const programmes = [
        ...
        categories: [
          ...
          },
          {
            name: {
              ...
              nn: 'Barne- og ungdomsarbeiderfag',
  ...
  {
    name: {
      nb: 'Salg, service og reiseliv (service og samferdsel)',
      nn: 'Sal, service og reiseliv (service og samferdsel)',
      en: 'Salg, service og reiseliv (service og samferdsel)',
    },
    url: {
...
export const getProgrammeBySlug = (slug: string, locale?: string ) => {
  return programmes.find(item => {
    if (item.url) {
      if (locale) {
        ...
        // @ts-ignore
        return Object.keys(item.url).find((localee) => item.url[localee] === slug);
      }
    }
    return false;
  });

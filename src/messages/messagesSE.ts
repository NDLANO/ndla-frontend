  ...
  myNdla: {
    ...
    learningpath: {
      ...
      toast: {
        ...
        deletedFailed: "Kunne ikke slette læringstien",
        ...
        createdStepFailed: "Et steg med tittel '{{ name }}' ble opprettet.",
        deletedStep: "Et steg med tittel '{{ name }}' ble slettet.",
        deletedStepFailed: "Et steg med tittel '{{ name }}' ble opprettet.",

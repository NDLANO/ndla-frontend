...
export const initializeI18n = (i18n: i18n, language: string): i18n => {
  ...
  instance.addResourceBundle('en', 'translation', en, false, false);
  instance.addResourceBundle('nb', 'translation', nb, false, false);
  instance.addResourceBundle('nn', 'translation', nn, false, false);
  return instance;
};
